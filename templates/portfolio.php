    ...
    <section class="section">
        ...
        <div class="placement-slots">
            ...
            <div class="placement-slot <?= $placed ? 'filled' : 'empty' ?>">
                <?php if ($placed): ?>
                <div class="ps-card">
                    <span class="rarity-badge <?= !empty($placed['limited_edition']) ? 'limited' : GachaEngine::rarityClass($placed[\'rarity\']) ?>"><?= !empty($placed['limited_edition']) ? '绝版' : (GachaEngine::rarityNames()[GachaEngine::rarityClass($placed[\'rarity\'])] ?? GachaEngine::rarityClass($placed[\'rarity\'])) ?></span>
        ...
        <div class="stock-table-wrapper">
            <table class="stock-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <span class="stock-symbol-table <?= GachaEngine::rarityClass($h[\'rarity\']) ?>"><?= htmlspecialchars($h['symbol']) ?></span>
                        </td>
