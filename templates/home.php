...
<div class="page-home">
            ...
            <div class="stock-mini-list">
                ...
                <a href="./market_detail.php?id=<?= $s['id'] ?>" class="stock-mini-item">
                    <div class="stock-mini-header">
                        <span class="rarity-badge small <?= !empty($s['limited_edition']) ? 'limited' : GachaEngine::rarityClass($s[\'rarity\']) ?>"><?= !empty($s['limited_edition']) ? '绝版' : (GachaEngine::rarityNames()[GachaEngine::rarityClass($s[\'rarity\'])] ?? GachaEngine::rarityClass($s[\'rarity\'])) ?></span>
                        <span class="stock-symbol <?= GachaEngine::rarityClass($s[\'rarity\']) ?>"><?= htmlspecialchars($s['symbol']) ?></span>
    ...
    <section class="section">
        ...
        <div class="stock-mini-list">
            ...
            <a href="./market_detail.php?id=<?= $s['id'] ?>" class="stock-mini-item">
                <div class="stock-mini-header">
                    <span class="rarity-badge <?= !empty($s['limited_edition']) ? 'limited' : GachaEngine::rarityClass($s[\'rarity\']) ?>"><?= !empty($s['limited_edition']) ? '绝版' : (GachaEngine::rarityNames()[GachaEngine::rarityClass($s[\'rarity\'])] ?? GachaEngine::rarityClass($s[\'rarity\'])) ?></span>
