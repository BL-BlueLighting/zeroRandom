...
<div class="page-auth">
    <div class="auth-card" style="max-width:450px;text-align:center">
        <h1 class="auth-title">📅 每日签到</h1>
        <p class="auth-subtitle">每天签到领取 <?= CheckinEngine::DAILY_REWARD ?> 枚代币</p>
        ...
        <?php if ($canCheckin): ?>
        <form method="POST">
            <button class="btn btn-primary btn-lg btn-block">🎯 领取 <?= CheckinEngine::DAILY_REWARD ?> 代币</button>
        </form>
        <?php else: ?>
